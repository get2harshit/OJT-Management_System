...
import { apiGetMySessions } from '../../lib/api';

export default function MentorAttendance() {
  // The OJT comes from the route — MentorOjtLayout owns the picker, so this
  // page no longer keeps a second one that could disagree with it.
