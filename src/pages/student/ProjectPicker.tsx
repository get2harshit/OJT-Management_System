    ...
    <div className="h-full min-h-0 flex flex-col space-y-4">
      ...
      <div className="flex-1 min-h-0 bg-zinc-850 border border-zinc-750 rounded-xl flex flex-col overflow-hidden">
        ...
        <div className="flex-1 min-h-0 p-6 sm:p-8 space-y-6 overflow-y-auto">
          ...
          {(detail.recommendedMentors?.length || detail.creditMapping || detail.partners?.length) && (
            <div className="space-y-3">
              ...
              {detail.creditMapping && (
                <div>
                  <p className="text-xs text-gray-500 uppercase font-bold tracking-wider mb-1">Credit mapping</p>
                  <p className="text-sm text-gray-200">{detail.creditMapping}</p>
                </div>
              )}
